...
> 面向普通开发者和入门开发者的 blockcell 系列索引，当前共 28 篇，全部基于真实代码与当前实现整理。
...
- CLI、Provider、MCP、Provider Pool、ModelRouter、intentRouter、多智能体配置等更贴近真实产品落地的专题
...
**如果你想做真实产品配置：** 02 → 08 → 17 → 18 → 19 → 20 → 28 → 21

**如果你想理解系统内部设计：** 11 → 12 → 13 → 15 → 16 → 27 → 28
